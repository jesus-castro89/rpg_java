import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,b as t}from"./app-So-GmRFm.js";const p={},e=t(`<h2 id="player" tabindex="-1"><a class="header-anchor" href="#player"><span>Player</span></a></h2><p>Ahora que ya contamos con nuestro inventario, recuerda agregarlo a la clase Player, en este caso dejo para ustedes el formato completo de la clase para tomar como referencia. Recuerden que pueden y deben cambiar los nombres de algunas funciones, puesto que se deberán de agregar atributos diferentes en cada uno de los equipos de trabajo.</p><div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">player</span><span class="token punctuation">;</span>
